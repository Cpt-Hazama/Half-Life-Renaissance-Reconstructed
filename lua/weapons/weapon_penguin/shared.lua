...
if SERVER then
	...
	local function CreateWorldModel(self)
		...
		entModel:SetModel("models/weapons/opfor/w_penguinnest.mdl")
...
SWEP.ViewModel = "models/weapons/opfor/v_penguin.mdl"
SWEP.WorldModel = "models/weapons/opfor/p_penguin.mdl"
SWEP.Category		= "SLVBase - Half-Life Renaissance"

SWEP.Primary.Automatic = false
SWEP.Primary.SingleClip = true
SWEP.Primary.Ammo = "penguin"
...
function SWEP:PrimaryAttack()
	...
	local entSnark = ents.Create("monster_penguin")
