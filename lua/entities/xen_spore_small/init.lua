...
function ENT:Initialize()
	...
	self:SetModel("models/half-life/fungus_small.mdl")
end

function ENT:Think()
	local cboundMin = self:GetRight() *26 +self:GetForward() *26 +self:GetUp() *70
	local cboundMax = self:GetRight() *-26 +self:GetForward() *-26
