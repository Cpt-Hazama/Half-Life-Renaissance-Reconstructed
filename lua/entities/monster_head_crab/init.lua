...
util.AddNPCClassAlly(CLASS_HEADCRAB,"monster_head_crab")
ENT.sModel = "models/half-life/headcrab.mdl"
ENT.fRangeDistance	= 235
ENT.bPlayDeathSequence = false

ENT.skName = "headcrab_hl1"
...
function ENT:EventHandle(...)
	...
	if(event == "mattack") then
		...
		local fDist = 20
		local iDmg = GetConVarNumber("sk_headcrab_hl_dmg_bite")
